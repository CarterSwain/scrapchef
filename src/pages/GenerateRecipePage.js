  ...
  return (
    ...
    <div className="relative mb-8 w-full max-w-2xl">
      <textarea
        ...
        rows={3}
        className="w-full px-4 py-3 text-base sm:text-lg text-gray-700 border-2 border-tomato rounded-lg focus:outline-none focus:ring-2 focus:ring-red-400 resize-y"
      />
      <button
